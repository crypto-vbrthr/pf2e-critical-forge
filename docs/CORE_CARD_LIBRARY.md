...
Version `0.8.0-rc.2` freezes the deliberately balanced 96-card playtest library. The four spell-attack and saving-throw categories contain generic fallbacks and focused results for repeated table use, while their prose and weighting remain playtest material.
