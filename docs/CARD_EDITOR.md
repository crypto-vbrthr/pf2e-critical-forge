...
Version `0.9.0-dev` freezes the GM-only visual editor for Critical Forge card packs, the Effect Forge return workflow, deterministic collision-free card IDs, pack activation, and the tested end-to-end pack roundtrip.
