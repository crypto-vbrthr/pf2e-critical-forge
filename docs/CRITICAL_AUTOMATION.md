...
Version `0.9.1-dev` freezes the connection between the PF2e Context Adapter, trigger policy, profile weighting, card selector, and chat-card publisher for supported PF2e critical rolls.
