...
- [ ] Open Critical Diagnostics and confirm the toolbar shows `Schlachtfeldanalyse · 1.0.0-rc`, the three pipeline phases, session history, replay buttons, runtime-context summary, requested deck, and raw snapshot.
